...
describe 'WithdrawalAccounts', vcr: true do
  ...
  it 'can find #withdrawal_accounts' do
    withdrawal_accounts = CurrencyCloud::WithdrawalAccount.find(account_id: '72970a7c-7921-431c-b95f-3438724ba16f')
  ...
  it 'can find #withdrawal_accounts2' do
    ...
    withdrawal_account_1 = withdrawal_accounts[0]
    expect(withdrawal_account_1).to be_a(CurrencyCloud::WithdrawalAccount)
    expect(withdrawal_account_1.id).to eq('0886ac00-6ab6-41a6-b0e1-8d3faf2e0de2')
    expect(withdrawal_account_1.account_name).to eq('currencycloud')
    expect(withdrawal_account_1.account_holder_name).to eq('The Currency Cloud')
    expect(withdrawal_account_1.account_holder_dob).to be_nil
    expect(withdrawal_account_1.routing_code).to eq('123456789')
    expect(withdrawal_account_1.account_number).to eq('01234567890')
    expect(withdrawal_account_1.currency).to eq('USD')
    expect(withdrawal_account_1.account_id).to eq('72970a7c-7921-431c-b95f-3438724ba16f')

    withdrawal_account_2 = withdrawal_accounts[1]
    expect(withdrawal_account_2).to be_a(CurrencyCloud::WithdrawalAccount)
    expect(withdrawal_account_2.id).to eq('0886ac00-6ab6-41a6-b0e1-8d3faf2e0de3')
    expect(withdrawal_account_2.account_name).to eq('currencycloud2')
    expect(withdrawal_account_2.account_holder_name).to eq('The Currency Cloud 2')
    expect(withdrawal_account_2.account_holder_dob).to eq('1990-07-20')
    expect(withdrawal_account_2.routing_code).to eq('223456789')
    expect(withdrawal_account_2.account_number).to eq('01234567892')
    expect(withdrawal_account_2.currency).to eq('GBP')
    expect(withdrawal_account_2.account_id).to eq('72970a7c-7921-431c-b95f-3438724ba16e')
  end

  it 'can pull funds' do
    withdrawal_account_funds = CurrencyCloud::WithdrawalAccount.pull_funds("0886ac00-6ab6-41a6-b0e1-8d3faf2e0de2",
